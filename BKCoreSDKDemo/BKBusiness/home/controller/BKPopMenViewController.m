...
@interface BKPopMenViewController ()
@property (nonatomic, strong) UITableView *tableView;
@property (nonatomic, strong) NSArray *addArray;

@end

@implementation BKPopMenViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    //弹出窗内容
    self.addArray = [[NSMutableArray alloc] initWithObjects:@"选择币种",@"搜索币种", nil];
